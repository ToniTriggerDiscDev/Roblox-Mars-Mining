...
UPGRADES = {
    ...
    # Kosten synchron mit GameConfig 2026-07-14 (Option B: 570/2400/9300/44000/570000/1800000)
    "Drill":  ([570, 2400, 9300, 44000, 570000, 1800000], [2, 2.8, 4, 5, 7, 9.5, 12]),
    "Cargo":  ([570, 2400, 9300, 44000, 570000], [7, 15, 25, 40, 70, 120]),
    "Fuel":   ([570, 2400, 9300, 44000, 570000, 1800000], [10, 15, 25, 40, 60, 100, 150]),
    "Engine": ([570, 2400, 9300, 44000, 570000, 1800000], [6, 6.4, 6.8, 7.2, 7.6, 8, 8.4]),
}
FUEL_FLY = 0.33
FUEL_IDLE = 0.08
FUEL_PRICE = 1  # $/L
